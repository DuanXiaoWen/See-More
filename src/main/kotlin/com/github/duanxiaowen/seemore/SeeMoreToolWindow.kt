...
class SeeMoreToolWindow {
    private lateinit var runButton: JButton
    private lateinit var SeeMoreToolWindowContent: JPanel
    ...
    init {
        ...
        this.searchTextField.addKeyListener(object: KeyListener {
            ...
            override fun keyReleased(keyEvent: KeyEvent) {
                this@SeeMoreToolWindow.canvas.repaint()
            }
        })
    ...
    fun getContent() = this.SeeMoreToolWindowContent

    fun isFocusedMethod(method: PsiMethod) = this.focusedMethods.contains(method)

    fun toggleFocusedMethod(method: PsiMethod): SeeMoreToolWindow {
    ...
    fun clearFocusedMethods(): SeeMoreToolWindow {
        this.focusedMethods.clear()
        enableFocusedMethodButtons()
        return this
    }
        ...
        if (project != null) {
            Utils.runBackgroundTask(project, Runnable {
                ...
                val canvasConfig = CanvasConfig(
                        ...
                        buildType,
                        this.canvas,
                        this@SeeMoreToolWindow.moduleScopeComboBox.selectedItem as String? ?: "",
                        this@SeeMoreToolWindow.directoryScopeTextField.text,
                        this@SeeMoreToolWindow.focusedMethods,
                        this@SeeMoreToolWindow
                )
                // start building graph
                setupUiBeforeRun(buildType)
                this@SeeMoreToolWindow.canvasBuilder.build(canvasConfig)
                setupUiAfterRun()
            })
        }
    }
